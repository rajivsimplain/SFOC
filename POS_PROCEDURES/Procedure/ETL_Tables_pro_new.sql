...
/****** Object:  StoredProcedure [dbo].[ETL_Tables_pro_new]    Script Date: 2/5/2025 11:08:46 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[ETL_Tables_pro_new] 
...
IF @mode=0	 -- Manual Mode	
	  ...
	  begin
		...
		END
			...
			update ETL_Table_Columns set  Initialize_Flag='Y' where Table_id=@tid;
